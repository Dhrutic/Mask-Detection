...
def draw_box_on_image(num_hands_detect, score_thresh, scores, boxes, classes, im_width, im_height, image_np,Line_Position2,Orientation):
    ...
    focalLength = 3575
    # The average width of a Mask (inches) http://www.theaveragebody.com/average_hand_size.php
    ...
    for i in range(num_hands_detect):
        ...
        if (scores[i] > score_thresh):
            ...
            if classes[i] == 2:
                id ='Please wear Mask'
                avg_width = 4.0 # To compensate bbox size change
                color = color0
...
def draw_text_on_image(fps, image_np):
    cv2.putText(image_np, fps, (20, 50),
                cv2.FONT_HERSHEY_SIMPLEX, 0.75, (236, 81, 4), 2)
